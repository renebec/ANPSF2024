...
function myFunction0() {
  ...
  if (dots0.style.display === "none") {
    ...
    btnText0.innerHTML = "Leer más";
    moreText0.style.display = "none";
  } else {
    dots0.style.display = "none";
    btnText0.innerHTML = "Mostrar menos";
...
function myFunction3() {
  ...
  if (dots3.style.display === "none") {
    ...
    btnText3.innerHTML = "Mostrar menos";
...
function myFunction4() {
  ...
  if (dots4.style.display === "none") {
    ...
    btnText4.innerHTML = "Leer más";
    moreText4.style.display = "none";
  } else {
    dots4.style.display = "none";
    btnText4.innerHTML = "Mostrar menos";
...
function myFunction5() {
  ...
  if (dots5.style.display === "none") {
    ...
    btnText5.innerHTML = "Leer más";
    moreText5.style.display = "none";
  } else {
    dots5.style.display = "none";
    btnText5.innerHTML = "Mostrar menos";
...
function myFunction6() {
  ...
  if (dots6.style.display === "none") {
    ...
    btnText6.innerHTML = "Leer más";
    moreText6.style.display = "none";
  } else {
    dots6.style.display = "none";
    btnText6.innerHTML = "Mostrar menos";
...
function myFunction7() {
  ...
  if (dots7.style.display === "none") {
    ...
    btnText7.innerHTML = "Leer más";
    moreText7.style.display = "none";
  } else {
    dots7.style.display = "none";
    btnText7.innerHTML = "Mostrar menos";
